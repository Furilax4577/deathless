...
- **Jauge de parade et parade parfaite** {décidé} (26/09/2026, principe ; valeurs {à équilibrer}) :
  ...
  - **Attaques à distance** {décidé} (26/09/2026) : seules les attaques physiques au corps à corps se parent. Un projectile (crâne du Nécromancien) ne peut être que **bloqué** par la garde, quel que soit le moment : il coûte de l'endurance et n'étourdit pas le tireur.
