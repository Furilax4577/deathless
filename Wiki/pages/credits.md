...
Deathless est développé par Quentin Douville.

## Assets graphiques

| Contenu | Auteur | Licence |
|---|---|---|
| Personnages, animations, armes, squelettes, forêt, bâtiments, donjon (packs KayKit) | Kay Lousberg, [kaylousberg.com](https://kaylousberg.com) | CC0 |
| Icônes de boutons Xbox, PlayStation, clavier et souris (Input Prompts) | Kenney, [kenney.nl](https://kenney.nl) | CC0 |

Les licences CC0 n'exigent pas de crédit : ils figurent ici par reconnaissance.
...
{dev} Unity 6. Le détail technique des assets et de leur emplacement est dans `Docs/assets-tiers.md`.
