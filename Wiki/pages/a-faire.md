...
- Forêt : arbres plus riches et moins nombreux (preuve de concept en cours), troncs dégagés jusqu'à 1,5 fois la hauteur des personnages ; **les squelettes traversent la forêt entre les troncs** au lieu de toujours suivre le même chemin (variété des trajets : points de passage au hasard ou coût de chemin bruité). Idée de Quentin, 26/09/2026.
