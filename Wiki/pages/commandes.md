...
| Attaque principale | RT | R2 | Clic gauche | {à confirmer} |
| Attaque secondaire, garde, parade, visée | LT | L2 | Clic droit | {à confirmer} |
| Compétence 1 | LB | L1 | A | {à confirmer} |
| Compétence 2 | RB | R1 | R | {à confirmer} |
| Compétence 3 | LB + RB | L1 + R1 | F | {à confirmer} |
| Ultime | L3 + R3 | L3 + R3 | G | {à confirmer} |
...
| Se déclarer prêt | Vue | Pavé tactile | F1 | {à confirmer} |
